...
class Motto extends Entity {

    /**
     * @var string
     */
    protected $model = 'App\Motto';
    ...
    public function fields($schema)
    {
        ...
        $schema->string('motto_title');
        $schema->text('motto_desc');
        $schema->string('motto_logo');
        $schema->timestamps();
    }
    ...
    {
        $schema->col('id');
        $schema->col('motto_title');
        $schema->col('motto_logo');
